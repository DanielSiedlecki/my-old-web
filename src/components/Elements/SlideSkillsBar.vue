<template>
    <div id="carouselExampleControls" class="carousel slide w-100" data-ride="carousel">
      <div class="carousel-inner " style="width: 100%;">
        <div class="carousel-item active" >
          <div class="row justify-content-center " style="">
              ...
              <skills-card-vue  class="col-6 col-md-3 mb-2 w-auto  " :number="3" :icon="`my-icon-adobe-photoshop`" :skill_name="`Adobe Photoshop`" :skill_level="`Regular`"/>
              <skills-card-vue class="col-6 col-md-3 mb-2 w-auto " :number="3" :icon="`my-icon-figma`" :skill_name="`Figma`" :skill_level="`Regular`" />
      ...
      <button class="carousel-control-prev" type="button" style="color:black" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
  ...
  <script>
import SkillsCardVue from './SkillsCard.vue'

  export default {
    components: { SkillsCardVue},
