<template>
  ...
  <div class="container mx-auto " style="margin-top:10vh; min-height: 100vh;">
...
import PortoflioCard from './Elements/PortoflioCard.vue'
export default {
  components: { PageHeader, PortoflioCard },
  ...
  data(){
    return {
      Cards: [
            ...
            {id:2, header: 'adam-skakowski.pl', src: require('../assets/Portfolio/inBuilding.png'), frontend: 'Vue.js', description: '', status: 'In soon'},
            {id:3, header: 'Live Chat app', src: require('../assets/Portfolio/inBuilding.png'), frontend: 'Angular', Backend: 'Node.js', status: 'In soon'},
            {id:4, header: 'Concierge system', src: require('../assets/Portfolio/web3.png'), href: 'https://github.com/DanielSiedlecki/EmployeesOffice', frontend: 'Vue.js', backend: 'Node.js', status: 'Check code', description: "This is an office traffic control system."},
                      ]
    }
  }
